...
/**
 * @description Add user membership to a group
 */
...
/**
 * @description Remove user membership from a group
 */
...
/**
 * @description Update group permission scopes for a target resource type
 */
exports.updateGroupPermissions = async (req, res) => {
    try {
        ...
        // Replace existing permissions for this resource type + target label stored in resourceId-compatible field
        group.permissions = [
            ...group.permissions.filter(
                (permission) =>
                    !(permission.resourceType === normalizedResourceType && permission.target === target)
            ),
