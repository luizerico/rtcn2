...
const storedFileSchema = new Schema(
  {
    ...
    analysis: {
      ...
      statusSummary: { type: String, default: null, trim: true, maxlength: 2000 },
      progressStep: { type: String, default: null, trim: true, maxlength: 64 },
      progressCompleted: { type: Number, default: null },
      progressTotal: { type: Number, default: null },
      queuePosition: { type: Number, default: null },
      resultLoggedAt: { type: Date, default: null },
    },
