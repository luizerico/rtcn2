...
async function initializeAdmin() {
  ...
  try {
    ...
    console.log(
      'Admin group members can manage users/groups; asset permissions cover DOCUMENT, DASHBOARD, DATASET, SURVEY, SPONSOR, OPPORTUNITY, PROJECT. Survey answers inherit SURVEY:READ; results are admin-only.'
    );
