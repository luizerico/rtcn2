...
async function initializeAdmin() {
  ...
  try {
    ...
    console.log(
      'Admin group members can manage users/groups; asset permissions cover SURVEY, SPONSOR, OPPORTUNITY, PROJECT, and COUNTY subjects. County read views sheets; create starts a sheet; modify edits existing sheets.'
    );
